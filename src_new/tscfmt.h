...
//     [Sub-block (N-1).(M-1)]
//   [LUT header             ]  --
//     [LUT entry 0          ]   | yet to be implemented
//     ...                       |
//     [LUT entry (N-1)      ]  --
//
...
//typedef struct tsclut_t_ {
//    unsigned char magic[8]; // "lut----" + '\0'
//    uint64_t      lut_sz;   // LUT size
//    unsigned char *lut;     // LUT data (= block headers w/o 'bh_fpos_nxt')
//}tsclut_t;
