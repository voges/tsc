...
static void print_help(void)
{
    ...
    printf("       Uncompress: tsc -u [options] <file.tsc>\n");
...
static void parse_options(int argc, char *argv[])
{
    ...
    const char *short_options = "b:fho:suvV";
    ...
    do {
        ...
        case 's':
            ...
            break;
        case 'u':
            if (!strcmp(tsc_prog_name->s, "untsc"))
                tsc_error("Already in uncompressor mode. Flag '-u' is redundant.\n");
            tsc_mode = TSC_MODE_UNCOMPRESS;
            break;
        case 'v':
...
int main(int argc, char* argv[])
{
    ...
    /* If invoked as 'untsc', switch to uncompressor mode. */
    if (!strcmp(tsc_prog_name->s, "untsc")) tsc_mode = TSC_MODE_UNCOMPRESS;
