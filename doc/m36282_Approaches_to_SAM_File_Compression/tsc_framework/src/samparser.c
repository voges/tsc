...
/******************************************************************************
 * This is the SAM parser from DeeZ, (re-)written in C, from:                 *
 *  Faraz Hach,	Ibrahim Numanagic & S. Cenk Sahinalp: DeeZ: reference-based   *
 *  compression by local assembly, Nature Methods 11, 1082–1084 (2014)        *
